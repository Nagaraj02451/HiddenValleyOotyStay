                ...
                <div className="bpro5">
                  ...
                  <div className="">
                    <div className="gfctyhgc">
                      <div>
                        <div className="bpro52a">VILLA</div>
                        <div className="bpro52b">4 Bedrooms | 2 Attic | 2 Living Areas   </div>
                      </div>
                ...
                <div className="book8">
                 ...
                 {pizza.roomR === 10 ? (
                  ...
                  <div className="book82">
                    ...
                    <div className="book84">TinyHouse</div>
                  </div>
