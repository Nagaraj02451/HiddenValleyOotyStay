...
const RiversideBooking = ({addBase, adult , pizza , child , dateone , datetwo  , stay , roomR , taxR , totalR}) => {
           ...
           <div className='bpro3'>
             ...
             <div className='bpro4'>
                      <div className='bpro5'>
                           ...
                           <div className=''>
                              ...
                              <div className='bpro52b'>3 Rooms | 4 People per room  </div>
                              </div>
                      ...
                      <div className='bpro5'>
                           ...
                           <div className=''>
                              ...
                              <div className='bpro52b'>1 Dorm Room | 6 People per room  </div>
                              </div>
                              <div className='uytghfyvj'>
                            <div>
                            <div className='bpro52g'>Starting From 4800</div>
                      ...
                      <div className='bpro5'>
                           ...
                           <div className=''>
                              ...
                              <div className='bpro52b'>1 Room | 4 People per room </div>
                              </div>
                              <div className='uytghfyvj'>
                            <div>
                      ...
                      <div className='bpro5'>
                           ...
                           <div className=''>
                              ...
                              <div className='bpro52b'>1 Room | 6 People per room  </div>
                              </div>
                              <div className='uytghfyvj'>
                            <div>
                            <div className='bpro52g'>Starting From 3000</div>
             ...
             <div className='bpro4a'>
                    ...
                    <div className='book82'><div className='book83'>Date:</div><div className='book84'> {pizza.dateone} - {pizza.datetwo}</div></div>
                     ...
                     <div className='book82'><div className='book83'>Stay:</div><div className='book84'>Riverside</div></div>
