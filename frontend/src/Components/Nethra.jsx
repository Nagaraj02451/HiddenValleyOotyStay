...
const Nethra = ({ addBase, adult, pizza, child, dateone, datetwo, roomR }) => {
          ...
          <div className="osbN">
            <div className="osc">
              ...
              <div className="os31">
                ...
                <div className="os33">
                  Tucked away in a lush coffee plantation, Nethra Hidden Valley
                  offers a
                  <br /> serene escape into nature. Wake up to the aroma of
                  fresh coffee, take a
                  <br />
                  scenic walk to a hidden waterfall, and unwind in cozy
                  accommodations
                  <br /> with private patios. Perfectly located for both
                  relaxation and
                  <br />
                  exploration, this is your gateway to the untouched beauty of
                  Coorg.{" "}
                </div>
                <div className="os33a">
                  Tucked away in a lush coffee
                  <br />
                  plantation, Nethra Hidden Valley
                  <br />
                  offers a serene escape into nature.
                  <br /> Wake up to the aroma of fresh
                  <br />
                  coffee, take a scenic walk to a
                  <br />
                  hidden waterfall, and unwind in
                  <br />
                  cozy accommodations with private
                  <br /> patios. Perfectly located for both
                  <br /> relaxation and exploration, this is
                  <br />
                  your gateway to the untouched
                  <br />
                  beauty of Coorg.
                </div>

                <Link to="/nethraBooking">
                  <div className="os34">
